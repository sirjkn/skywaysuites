...
export const HeroSlider = () => {
  ...
  return (
    <div className="relative w-full h-[600px] overflow-hidden bg-[#36454F]">
      {/* Slides */}
          ...
          <div className="absolute inset-0 flex items-center">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
              <div className="max-w-2xl">
                ...
                <Button 
                  size="lg"
                  className="bg-[#6B7F39] hover:bg-[#556230] text-white text-lg px-8 py-6 animate-fade-in delay-200"
      ...
      <button
        onClick={prevSlide}
        className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/40 backdrop-blur-sm text-white p-3 rounded-full transition-all duration-300 group"
      ...
      <button
        onClick={nextSlide}
        className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/40 backdrop-blur-sm text-white p-3 rounded-full transition-all duration-300 group"
